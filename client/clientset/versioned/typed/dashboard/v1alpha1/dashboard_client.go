...
// DashboardV1alpha1Client is used to interact with features provided by the dashboard.grafana.kubeform.com group.
...
func (c *DashboardV1alpha1Client) Permissions(namespace string) PermissionInterface {
