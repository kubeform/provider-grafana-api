...
// AlertV1alpha1Client is used to interact with features provided by the alert.grafana.kubeform.com group.
type AlertV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AlertV1alpha1Client) Notifications(namespace string) NotificationInterface {
