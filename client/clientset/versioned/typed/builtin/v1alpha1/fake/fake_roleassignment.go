...
type FakeRoleAssignments struct {
	Fake *FakeBuiltinV1alpha1
	ns   string
}

var roleassignmentsResource = schema.GroupVersionResource{Group: "builtin.grafana.kubeform.com", Version: "v1alpha1", Resource: "roleassignments"}

var roleassignmentsKind = schema.GroupVersionKind{Group: "builtin.grafana.kubeform.com", Version: "v1alpha1", Kind: "RoleAssignment"}
