...
import (
	...
	v1alpha1 "kubeform.dev/provider-grafana-api/apis/user/v1alpha1"
...
var usersResource = schema.GroupVersionResource{Group: "user.grafana.kubeform.com", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "user.grafana.kubeform.com", Version: "v1alpha1", Kind: "User"}
