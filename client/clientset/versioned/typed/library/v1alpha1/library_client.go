...
type LibraryV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*LibraryV1alpha1Client, error) {
	...
	return &LibraryV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LibraryV1alpha1Client for the given config and
...
func New(c rest.Interface) *LibraryV1alpha1Client {
	return &LibraryV1alpha1Client{c}
}
