...
var foldersResource = schema.GroupVersionResource{Group: "folder.grafana.kubeform.com", Version: "v1alpha1", Resource: "folders"}

var foldersKind = schema.GroupVersionKind{Group: "folder.grafana.kubeform.com", Version: "v1alpha1", Kind: "Folder"}
