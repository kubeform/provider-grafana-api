...
import (
	v1alpha1 "kubeform.dev/provider-grafana-api/client/clientset/versioned/typed/folder/v1alpha1"
...
func (c *FakeFolderV1alpha1) Permissions(namespace string) v1alpha1.PermissionInterface {
