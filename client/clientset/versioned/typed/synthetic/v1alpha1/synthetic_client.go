...
type SyntheticV1alpha1Interface interface {
	RESTClient() rest.Interface
	MonitoringChecksGetter
	MonitoringProbesGetter
}
...
func NewForConfig(c *rest.Config) (*SyntheticV1alpha1Client, error) {
	...
	return &SyntheticV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SyntheticV1alpha1Client for the given config and
...
func New(c rest.Interface) *SyntheticV1alpha1Client {
	return &SyntheticV1alpha1Client{c}
}
