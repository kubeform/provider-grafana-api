...
// MachineV1alpha1Client is used to interact with features provided by the machine.grafana.kubeform.com group.
type MachineV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MachineV1alpha1Client) LearningJobs(namespace string) LearningJobInterface {
	return newLearningJobs(c, namespace)
}
