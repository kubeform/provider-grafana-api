...
import (
	v1alpha1 "kubeform.dev/provider-grafana-api/apis/cloud/v1alpha1"
...
// CloudV1alpha1Client is used to interact with features provided by the cloud.grafana.kubeform.com group.
type CloudV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudV1alpha1Client) Stacks(namespace string) StackInterface {
