...
import (
	...
	v1alpha1 "kubeform.dev/provider-grafana-api/client/listers/builtin/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BuiltinV1alpha1().RoleAssignments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BuiltinV1alpha1().RoleAssignments(namespace).Watch(context.TODO(), options)
			},
		},
		&builtinv1alpha1.RoleAssignment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *roleAssignmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&builtinv1alpha1.RoleAssignment{}, f.defaultInformer)
}
