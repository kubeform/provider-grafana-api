...
import (
	...
	user "kubeform.dev/provider-grafana-api/client/informers/externalversions/user"
...
func (f *sharedInformerFactory) Synthetic() synthetic.Interface {
	return synthetic.New(f, f.namespace, f.tweakListOptions)
}
