...
import (
	...
	v1alpha1 "kubeform.dev/provider-grafana-api/client/listers/dashboard/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DashboardV1alpha1().Permissions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DashboardV1alpha1().Permissions(namespace).Watch(context.TODO(), options)
			},
		},
		&dashboardv1alpha1.Permission{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *permissionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dashboardv1alpha1.Permission{}, f.defaultInformer)
}
