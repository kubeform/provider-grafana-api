...
import (
	...
	v1alpha1 "kubeform.dev/provider-grafana-api/client/listers/cloud/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudV1alpha1().Stacks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudV1alpha1().Stacks(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudv1alpha1.Stack{},
		resyncPeriod,
...
func (f *stackInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudv1alpha1.Stack{}, f.defaultInformer)
}
